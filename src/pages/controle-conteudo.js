...
import ControleConteudoTable from '../components/ControleConteudoTable';
import UploadExcelTemplate from '../components/UploadExcelTemplate';

export default function ControleConteudo({ user }) {
  ...
  return (
    <div>
      <Head>
        <title>Controle de Conteúdo</title>
      </Head>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-2xl font-bold">Controle de Conteúdo</h1>
