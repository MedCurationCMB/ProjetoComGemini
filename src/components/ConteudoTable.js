...
const ConteudoTable = () => {
  ...
  const [tipoTextoVisualizando, setTipoTextoVisualizando] =
    useState("conteudo"); // 'conteudo' ou 'retorno_ia'
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                onClick={() => {
                  ...
                  if (
                    documentoEditando &&
                    documentoEditando === editandoConteudo.id
                  ) {
                    setFormEdicao((prev) => ({
                      ...prev,
              ...
              {(!editandoConteudo.conteudo ||
                ...
                <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-md mb-4">
                  <p className="text-yellow-800 font-medium mb-2">
                    Texto não disponível para extração
                  </p>
                  <p className="text-yellow-700">
                    Para extrair o texto deste documento, por favor, utilize
                    esta ferramenta:
                  </p>
                  <a
                  ...
                  <p className="mt-3 text-sm text-gray-600">
                    1. Na ferramenta, faça upload do documento PDF
                    <br />
                    2. Extraia o texto e copie-o
                    <br />
        ...
        <tbody className="divide-y divide-gray-300">
          {Array.isArray(conteudos) && conteudos.length > 0 ? (
            conteudos.map((item) => (
              <tr
                key={item.id}
                className={documentoEditando === item.id ? "bg-blue-50" : ""}
              >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-xs text-gray-500 mt-1">
                        {item.tamanho_arquivo
                          ? `${(item.tamanho_arquivo / 1024 / 1024).toFixed(
                              2
                            )} MB`
                  ...
                  <>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <div
                        ...
                        title={
                          documentoVinculacoes[item.id]?.length > 0
                            ? "Clique para ver todos os IDs vinculados"
                            : "Sem vinculações"
                        }
                      >
                      ...
                      <div className="flex flex-col space-y-2">
                        <div className="flex space-x-2">
                          ...
                          {item.retorno_ia && (
                            <button
                              onClick={() =>
                                visualizarTexto(item, "retorno_ia")
                              }
