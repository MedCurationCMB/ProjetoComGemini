...
import { FiBookOpen, FiEye, FiCalendar, FiClock, FiX } from 'react-icons/fi';

const HistoricoAnalisesIndicadorDialog = ({ indicadorId, onClose }) => {
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">
                  Ainda não foram realizadas análises para este indicador.
                </p>
              </div>
            ) : (
              <>
                ...
                <div className="mb-6 bg-blue-50 rounded-lg p-4 border border-blue-200">
                  <p className="text-blue-800 font-medium">
                    📊 Total de análises realizadas: <span className="font-bold">{historico.length}</span>
                  </p>
                  {historico.length > 0 && (
...
export default HistoricoAnalisesIndicadorDialog;